...
var ImageInfo={}; //regions etc for each slices, can be accessed by the slice name. (e.g. ImageInfo[imageOrder[viewer.current_page()]])
...
function initMicrodraw() {
	...
	$.getJSON(params.source, function(obj) {
		    ...
		    homeButton:"home",
                ...
                console.log('opening this tile source');
                console.log(ImageInfo[currentImage]["source"]);
                viewer.open(ImageInfo[currentImage]["source"]);
